...
import { getOrders, getMaterials, getEmployees, getNotifications } from '../../api/client.js'
    ...
    <div class="card">
      ...
      <ul class="alert-list">
        <li v-for="n in notifications" :key="n.id" class="alert-item">
          <span class="alert-dot" :style="{ background: notificationColors[n.type] || '#5b6f60' }"></span>
          <div>
